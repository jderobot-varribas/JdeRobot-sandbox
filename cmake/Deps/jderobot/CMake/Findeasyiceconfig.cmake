...
find_path(main_include NAMES EasyIce.h PATHS ENV C++LIB PATH_SUFFIXES ${libname})
find_library(main_lib NAMES ${libname} PATHS ENV C++LIB PATH_SUFFIXES ${libname} jderobot)
